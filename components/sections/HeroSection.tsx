...
I am a passionate Web developer. My expertise spans both front-end and back-end technologies, including React, Next.js, Node.js and MongoDB. I am proficient in C++ and JavaScript, and skilled in HTML5, CSS3, and React JS. I have experience with frameworks like Bootstrap 5 and Express JS, and am knowledgeable in NoSQL databases, particularly MongoDB.
            </motion.p>
          </div>
          ...
          >
            ...
            <div className="flex space-x-4">
              {[
                { icon: Github, href: "https://github.com/inzayn1", label: "GitHub" },
                { icon: Linkedin, href: "https://www.linkedin.com/in/aman-singh-228a55257/", label: "LinkedIn" },
                { icon: Mail, href: "mailto:amansingh1812as@gmail.com", label: "Email" }
              ].map((social, index) => (
                <motion.a
                  key={social.label}
                  href={social.href}
